...
<style>
/* VitePress aplica color de marca a `.vp-doc a`; forzamos contraste legible */
.vp-doc a.sponsor-card-link .sponsor-card-link__title {
  color: rgb(24 24 27) !important;
}
html.dark .vp-doc a.sponsor-card-link .sponsor-card-link__title {
  color: rgb(244 244 245) !important;
}
.vp-doc a.sponsor-card-link .sponsor-card-link__meta {
  color: rgb(82 82 91) !important;
}
html.dark .vp-doc a.sponsor-card-link .sponsor-card-link__meta {
